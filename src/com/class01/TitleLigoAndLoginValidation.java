...
public class TitleLigoAndLoginValidation extends CommonMethods {
...
//		sendText(username, "Admin");
		...
		WebElement welcomAd=driver.findElement(By.id("welcome"));
		
		boolean text=welcomAd.isDisplayed();
		System.out.println("Welcome Admin is displayed "+text);
